// The app runs as a worker on the second target. Reads HOST_URL as the public address; HOST_KEY
...
function base(): string {
  if (!env.HOST_URL) {
    throw new Error("HOST_URL is empty: the workers adapter needs the public address");
  }
