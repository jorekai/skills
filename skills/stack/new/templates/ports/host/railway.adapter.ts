// The app runs as a service on the fifth target. Reads HOST_URL as the public address; HOST_KEY
...
function base(): string {
  if (!env.HOST_URL) {
    throw new Error("HOST_URL is empty: the railway adapter needs the public address");
  }
